...
## Technical stuff
The project is written in ASP.NET Core using .NET 9 with a React UI. The design is made in bootstrap. The complete communication between UI and backend is done via WebSockets using the SignalR library. No effort was made to make the backend secure in any way.
